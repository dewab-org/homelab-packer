...
locals {
  ...
  autoinstall_user_data = templatefile("autoinstall/user-data.pkrtpl.hcl", {
  ...
  autoinstall_meta_data = file("autoinstall/meta-data")
...
source "proxmox-iso" "ubuntu_24_04" {
  ...
  template_description = "Ubuntu 24.04 template generated by Packer on ${formatdate("YYYY-MM-DD hh:mm:ss", timestamp())} UTC"
  onboot               = true
  ...
  boot_command = [
    ...
    "e<wait>",
    "<down><down><down><end>",
    " autoinstall ds=nocloud console=ttyS0,115200n8 ---<wait>",
    "<f10>"
  ]
  ...
  additional_iso_files {
    cd_content = {
      ...
      "/meta-data" = local.autoinstall_meta_data
    }
    cd_label         = "cidata"
