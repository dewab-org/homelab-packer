...
source "proxmox-iso" "rocky_9" {
  ...
  template_description = "Rocky Linux 9 template generated by Packer on ${formatdate("YYYY-MM-DD hh:mm:ss UTC", timestamp())}"
  onboot               = true
...
build {
  sources = ["source.proxmox-iso.rocky_9"]
