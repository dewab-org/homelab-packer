###############################################################################
# Name:             51-install-chocolatey-apps.ps1
# Description:      Installs a fixed list of eight general-purpose Chocolatey
#                   packages and proves each one landed by checking that
#                   Chocolatey registered it under <chocoRoot>\lib\<package>,
#                   not merely that choco exited 0.
...
#      C:\Install\51-install-chocolatey-apps.txt.
...
#      7zip.install, bginfo, chocolateygui, firefox, googlechrome,
#      notepadplusplus.install, pinginfoview, treesizefree.
...
#     these templates; no *.pkr.hcl references this script (or 50/52). It is
#     kept as a library script.
#   - Most of this list is GUI software (Firefox, Chrome, Chocolatey GUI,
#     Notepad++, PingInfoView, TreeSize). It is pointless on Server Core -
#     only run it against Desktop Experience images.
...
Start-Transcript -Path 'C:/Install/51-install-chocolatey-apps.txt' -Append
