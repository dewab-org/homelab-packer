...
source "proxmox-iso" "windows_server_2025_desktop_experience" {
  ...
  template_description = "Windows Server 2025 Desktop Experience template generated by Packer on ${formatdate("YYYY-MM-DD hh:mm:ss 'UTC'", timestamp())}"
  onboot               = true
  # Server 2025 maps to win11, NOT win10 - this was set to win10, copied from
  # the 2022 build. The cloud build carries the same note for the same reason.
  os = "win11"
