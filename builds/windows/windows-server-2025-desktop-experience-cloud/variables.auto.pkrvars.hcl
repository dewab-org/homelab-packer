# Windows Server 2025 Desktop Experience, cloned from the vendor evaluation image.
#
...
clone_vm_id   = 9424
vm_id         = 9434
template_name = "windows-server-2025-desktop-experience-cloud"

template_description_prefix = "Windows Server 2025 Desktop Experience cloud image template"
